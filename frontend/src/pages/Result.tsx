...
import { Sparkles, Trash2, MapPin, Zap, Info } from 'lucide-react';
...
export default function Result() {
  ...
  return (
    <motion.div 
      initial={{ opacity: 0, scale: 0.95 }}
      animate={{ opacity: 1, scale: 1 }}
      className="px-6 space-y-12 max-w-2xl mx-auto"
    >
      {/* Result Hero */}
          ...
          <div className="relative w-20 h-20 mb-3 flex items-center justify-center">
            <svg className="w-full h-full transform -rotate-90">
              ...
              <motion.circle 
                ...
                className="text-primary" cx="40" cy="40" fill="transparent" r="36" stroke="currentColor" strokeDasharray="226" strokeWidth="6" 
              />
            </svg>
